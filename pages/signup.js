...
<div className=" h-screen grid grid-cols-1 place-content-center  overflow-y-scroll  my-10 xs:my-0">
      <h2 className="text-2xl text-center font-bold mb-2 mt-24 tiny:mt-0">Sign Up</h2>
